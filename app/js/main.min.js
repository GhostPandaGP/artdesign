$(function(){
    ...
    // start popups
    $('.product-page__btn-serv').magnificPopup({
		type: 'inline',
		preloader: false,
		focus: '#name',
    ...
    $('.basket-page__total-btn').magnificPopup({
		type: 'inline',
		preloader: false,
		focus: '#name',
    ...
    $('.popup__btn-delivery').on("click", () => {
        $('.popup.form').addClass("popup-form--delivery");
        $('.popup__btn-delivery').removeClass("off");
        $('.popup__btn-pickup').addClass("off");
    })
    $('.popup__btn-pickup').on("click", () => {
        $('.popup.form').removeClass("popup-form--delivery");
        $('.popup__btn-delivery').addClass("off");
        $('.popup__btn-pickup').removeClass("off");
    })
    // end popups
